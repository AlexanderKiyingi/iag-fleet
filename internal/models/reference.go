...
var MaintenanceStatuses = []string{"scheduled", "in-progress", "completed", "overdue"}
var ComplianceStatuses = []string{"valid", "expiring", "expired", "missing"}
...
var RequestStatuses = []string{"submitted", "received", "reviewed", "approved", "assigned", "rejected", "completed"}
