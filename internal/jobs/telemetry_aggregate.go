...
func AggregateTelemetry(ctx context.Context, store *iot.Store, bus *events.Bus, from, to time.Time, vehicle string) (written, eventsWritten, failed int, err error) {
